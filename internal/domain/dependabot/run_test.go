...
func TestExcluded(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			patterns:    []repo.ExcludePattern{"acme/legacy.*"},
			owner:       "acme",
			repoName:    "legacy.api",
			wantPattern: "acme/legacy.*",
			wantHeld:    true,
		},
		{
		...
		},
		{
			...
			patterns: []repo.ExcludePattern{"acme/legacy.*"},
			owner:    "acme",
			repoName: "legacy-user.plugin",
		},
		{
			name:        "exact slug",
			patterns:    []repo.ExcludePattern{"acme/frozen.tool"},
			owner:       "acme",
			repoName:    "frozen.tool",
			wantPattern: "acme/frozen.tool",
			wantHeld:    true,
		},
		{
